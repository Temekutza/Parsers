...
find_a_by_text = soup.find("a", text="Обувь")
print(find_a_by_text)

find_a_by_text = soup.find("a", text="Обувь для детей")
print(find_a_by_text)

find_a_by_text = soup.find("a", text=re.compile("Обувь"))
print(find_a_by_text)

find_all_clothes = soup.find_all(text=re.compile("([Оо]бувь)"))
